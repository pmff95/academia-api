package com.example.demo.controller.carteira;
...
import com.example.demo.dto.carteira.RecargaManualRequest;
...
public class CarteiraController {
    ...
    @EurekaApiOperation(
            summary = "Verificar senha do cartão",
            description = "Valida a senha do cartão de um usuário."
    )
