...
import com.example.demo.repository.vendas.PagamentoRepository;
...
public class PagamentoService {
    ...
    public String registrarPreCompra(List<CriarPagamentoRequest> pagamentoRequestList) {
        ...
        List<PagamentoItem> itens = new ArrayList<>(pagamentoRequestList.size());
        ...
        pagamento.setStatusPagamento("criando_preference");
