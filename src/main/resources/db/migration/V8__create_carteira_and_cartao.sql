...
CREATE TABLE carteira (
                          ...
                          CONSTRAINT fk_carteira_aluno
                              FOREIGN KEY (aluno_id) REFERENCES aluno(id) ON DELETE NO ACTION,

                          CONSTRAINT fk_carteira_professor
                              FOREIGN KEY (professor_id) REFERENCES professor(id) ON DELETE NO ACTION,
...
CREATE INDEX idx_carteira_professor   ON carteira(professor_id);
