-- Criação da tabela disciplina (necessária antes da tabela de associação)
...
-- Índice para o campo uuid de disciplina
CREATE INDEX idx_disciplina_uuid ON disciplina(uuid);
